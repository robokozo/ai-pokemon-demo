...
const { id, name, position = [0, 0, 0], castShadow = false } = defineProps<Props>()

useEcsEntity({ id, name, kind: "prop", collider: "solid", colliderSize: { hw: 0.9, hd: 1.2 }, isStatic: true, position })
</script>
